...
alias ff='fastfetch --logo-color-2 red'
alias cls='clear'
alias xi='startx'
alias clean='sudo apt autoclean && sudo apt autoremove'
alias mci='sudo make clean install'
alias chdwm='cd ~/suckless/dwm; vim config.h; mci; cd -'
alias chblocks='cd ~/suckless/dwmblocks; vim blocks.h; mci; cd -'
alias cdblocks='cd ~/suckless/scripts/blocks'
